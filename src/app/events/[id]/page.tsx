        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_380px]">
          ...
          <article>
            ...
            {event.line_friend_url && (
              <section className="mb-8 animate-fade-in-up delay-300">
                <div className="rounded-2xl border border-[#06C755]/30 bg-[#06C755]/5 p-5">
                  {/* Header row */}
                  ...
                  <div className="grid gap-4 sm:grid-cols-[1fr_auto] sm:items-center">
                    <div className="flex flex-col gap-2">
                      ...
                      <p className="text-[11px] leading-relaxed text-[#666666] sm:hidden">
                        ↑ ボタンで追加できない場合、右のQRコードを<strong>長押し→画像を保存</strong>してLINEアプリの「友だち追加 → QRコード → 画像を選ぶ」で読み込んでください
                      </p>
                      <p className="hidden text-[11px] leading-relaxed text-[#666666] sm:block">
                        ボタンで追加できない場合は、スマホのLINEアプリで右のQRコードをスキャンしてください
                      </p>
                    </div>
                    {/* QR code */}
                    <div className="flex flex-col items-center gap-1 self-start">
                      ...
                      <img
                        src={`/api/line/qr?u=${encodeURIComponent(event.line_friend_url)}`}
                        alt="LINE友だち追加QRコード"
                        width={128}
                        height={128}
                        ...
                        loading="lazy"
                      />
                      <p className="text-[10px] text-[#999999]">QRコードで追加</p>
                    </div>
                  </div>
                </div>
              </section>
