...
import { LineFriendAddCard } from "@/components/line-friend-add-card";
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_380px]">
          ...
          <article>
            ...
            <section className="lg:hidden animate-fade-in-up delay-500" id="booking-form">
              {/* 申込前にLINE友だち追加を促す（取りこぼし防止）*/}
              {event.line_friend_url && !isClosed && (
                <div className="mb-5">
                  <LineFriendAddCard
                    lineFriendUrl={event.line_friend_url}
                    variant="prebooking"
                  />
                </div>
              )}
