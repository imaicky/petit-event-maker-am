...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Stripe連携によるオンライン決済に対応しています。参加者はクレジットカードで安全にお支払いいただけます。設定画面からStripeアカウントを連携するだけで、有料イベントの自動決済・返金処理が利用可能です。初めての方は「Stripe決済セットアップガイド（/settings/stripe/guide）」をご覧ください。",
  },
];
