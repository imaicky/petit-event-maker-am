...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  "お教室・レッスン": "from-rose-50 to-pink-50",
  ランチ会: "from-amber-50 to-orange-50",
  "飲み会・交流会": "from-orange-50 to-amber-50",
  Instagram: "from-pink-50 to-purple-50",
  "YouTube・動画": "from-red-50 to-rose-50",
  SNS集客: "from-violet-50 to-purple-50",
  LLM活用: "from-blue-50 to-indigo-50",
  画像生成: "from-fuchsia-50 to-pink-50",
  プロンプトエンジニアリング: "from-slate-50 to-gray-50",
  "AI×ビジネス": "from-emerald-50 to-teal-50",
  "AI開発・実装": "from-cyan-50 to-blue-50",
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "申し込み完了メールが自動送信されます。さらにLINE公式アカウントを連携すれば、イベントもサービスメニューもフォロワーへリッチカード告知を配信、予約確認のLINE通知、イベント前日＆当日の自動リマインダー（LINE+メール）まで全自動。参加者はGoogleカレンダーにワンタップ追加でき、主催者はCSVエクスポート＆出欠管理も可能です。",
  },
  {
  ...
  {
    q: "「サービスメニュー」機能とは何ですか？",
    a: "日付に依存しない定期サービスやメニューを公開できる機能です。たとえばネイルのデザインメニューやヨガの月額コースなど、お客さまが好きなタイミングで申し込めるページを作れます。カスタム申込フォームで必要な情報を収集でき、LINE通知・CSVエクスポート・出欠管理にも対応しています。",
  },
  {
    q: "有料イベントの支払いはどうなりますか？",
    a: "Stripe連携によるオンライン決済に対応しています。参加者はクレジットカードで安全にお支払いいただけます。設定画面（/settings/stripe）からStripeのシークレットキーを貼り付けるだけで、Webhook設定を含めすべて自動で連携されます。",
  },
];
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              {[
                ...
                },
                {
                  icon: "💳",
                  title: "Stripe決済連携",
                  desc: "有料イベントの参加費をStripeでオンライン決済。クレジットカードで安全に支払い、キャンセル時は自動返金。主催者への入金もスムーズです。",
                  badge: "NEW",
                },
                {
                  icon: "📆",
                  title: "カレンダーでイベント探索",
                  desc: "カレンダー表示でイベントを日付から簡単に発見。月ごとの一覧で予定が把握しやすく、気になる日をタップするだけでイベント一覧が表示されます。",
                  badge: "NEW",
                },
                {
                  icon: "📸",
                ...
                },
                {
                  icon: "📅",
                  title: "Googleカレンダー連携",
                  desc: "予約完了後、ワンタップでGoogleカレンダーに追加。参加者がイベントを忘れる心配がなくなり、当日の参加率がアップします。",
                  badge: "NEW",
                },
                {
                  icon: "📊",
                  title: "CSV & 出欠管理",
                  desc: "参加者・申込者一覧をCSVでダウンロード。当日の出欠チェックもワンタップで記録でき、「全員出席」の一括操作にも対応。イベント後の管理まで完結します。",
                  badge: "NEW",
                },
                {
                  icon: "📱",
                  title: "メニューもLINE通知対応",
                  desc: "サービスメニューもLINEでリッチカード告知＆予約確認通知が可能に。申込者にはカスタムフィールドの内容付きでLINE確認メッセージが届きます。",
                  badge: "NEW",
                },
                {
                  icon: "👩‍🏫",
        ...
        <section className="w-full bg-white py-20 sm:py-24 px-6">
          <div className="mx-auto max-w-5xl">
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-[#F2F2F2]">
                  {[
                    ...
                    ["メニューもLINEリッチカード通知", true, false],
                    ["双方向LINEメッセージ", true, false],
                    ["自動リマインダー（LINE+メール）", true, false],
                    ["セグメント配信", true, false],
                    ["Googleカレンダー連携", true, false],
                    ["CSVエクスポート & 出欠管理", true, false],
                    ["ストーリーズ画像自動生成", true, false],
                    ["サービスメニュー・申込フォーム", true, false],
                    ["オンライン決済（Stripe）", true, true],
                    ["カレンダーでイベント探索", true, false],
            ...
            <p className="mt-4 text-center text-xs text-[#999999]">
              ※ 2026年4月時点の主要イベントプラットフォーム（Peatix・こくちーず等）との比較
            </p>
          </div>
        </section>
